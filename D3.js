...
*/
 ...
 console.log("characthers e' "+characters)
...
for(let i=0;i<starWarsCharacters.length;i++){
 ...
 console.log("female characthers"+femaleCharacters)
...
switch (starWarsCharacters[i].eye_color){
    ...
    break
    default:{
      eyeColor.noColor.push(starWarsCharacters[i])
    }
    break
  }
}
...
*/
// starWarsCharacters[2].mass=5
// starWarsCharacters[3].mass=5
// starWarsCharacters[1].mass=5
...
for(let i=0;i<starWarsCharacters.length;i++ ){
    if(starWarsCharacters[i].gender==="n/a" && i%2===0){
      starWarsCharacters[i].gender="female"
    }else if(starWarsCharacters[i].gender==="n/a" && i%2!==0){
      starWarsCharacters[i].gender="male"
    }
  }
...
for(let i=0;i<starWarsCharacters.length;i++ ){
  for(let j=0; j<femaleCharacters.length;j++){
    if(starWarsCharacters[i].name===femaleCharacters[j]){
...
console.log(starWarsCharacters[num].name," ",starWarsCharacters[num].eye_color," ",starWarsCharacters[num].hair_color," ",starWarsCharacters[num].height," ",starWarsCharacters[num].mass)
